...
function updateSubscriptionOnServer(subscription) {
    ...
    if (subscription) {
        subscriptionGlobal = {endpoint: sub.endpoint, p256dh: sub.keys.p256dh, auth: sub.keys.auth}
    }
}
...
if ('serviceWorker' in navigator && 'PushManager' in window) {
    ...
    navigator.serviceWorker.register('/js/view/sw.js')
        .then(function(swReg) {
